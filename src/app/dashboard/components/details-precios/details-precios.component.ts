...
@Component({
  selector: 'app-details-precios',
  templateUrl: './details-precios.component.html',
  styleUrls: ['./details-precios.component.css']
})
export class DetailsPreciosComponent implements AfterViewInit {
  ...
  constructor(
    ...
    this.aRoute.queryParams.subscribe(params => {
      ...
      this.displayedColumns = ['codigo', 'fechainicio', 'fechafin', 'secuencial', 'estado', 'terminal', 'producto', 'margen', 'precio', 'editar', 'borrar'];
      // if (this.nameCol === 'clienteproducto') {
      //   this.getItems('cliente');
      //   this.flag = false;
      //   this.displayedColumns = ['codigo', 'name', 'editar'];
      // } else if (this.nameCol === 'comercializadoraproducto') {
      //   this.getItems('comercializadora');
      //   this.flag = false;
      //   this.displayedColumns = ['codigo', 'name', 'editar'];
      // }
      // else {
  ...
  getItems(col: any): void {
    console.log(col);
    this.cf.getItems(col, 'secuencial').subscribe(data => {
      this.items = [];
      data.forEach((element: any) => {
        this.items.push({
          id: element.payload.doc.id,
  ...
  getFilter(com: any): void {
    console.log(com);
    this.itemsFilter = this.items.filter(i => i.comercializadoraCodigo === com);
  ...
  newItem(): void {
    ...
    this.router.navigate(['/dashboard/precio']);
