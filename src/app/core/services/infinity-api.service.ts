...
export class InfinityApiService {
  ...
  public getItemInfinity(nombre: string, item: any): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.urlInfinity}/ec.com.infinity.modelo.${nombre}/porId`, { headers, params }
    ).pipe(
      tap((data: any) => {
        console.log(data);
      }),
  ...
  public addDataTable(tabla: string, data: any, tipo: number): Observable<any> {
    ...
    if (tipo === 1) {
      ...
      return this.http.put<any>(urlAction, data, { headers })
        .pipe(
          tap((d: any) => {
            console.log(d);
          }),
      ...
      return this.http.post<any>(urlAction, data, { headers })
        .pipe(
          tap((d: any) => {
            console.log(d);
          }),
